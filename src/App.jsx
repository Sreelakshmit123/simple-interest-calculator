    ...
    <div style={{ width: '100%', height: '100vh' }} className='d-flex justify-content-center align-items-center bg-dark'>
      <div style={{ width: '600px' }} className='bg-light p-5 rounded'>
        ...
        <form className="mt-5" onSubmit={handleCalculate}>
          ...
          {!validPrinciple && <div className="mb-3 text-danger fw-bolder"> Invalid Principal Amount
          </div>}
          <div className="mb-3">
          ...
          {!validRate && <div className="mb-3 text-danger fw-bolder"> Invalid Rate
          </div>}
          <div className="mb-3">
          ...
          {!validYear && <div className="mb-3 text-danger fw-bolder"> Invalid year
          </div>}
